...
| `AboutImageCarousel` | gallery, about, case studies, capabilities | `client:idle` / `client:load` | ⚠️ Auto-advance carousel - could be CSS-only with reduced motion |
...
- about.astro: 3x AboutImageCarousel, StickyMobileCTA
- contact.astro: ContactForm
- gallery.astro: 3x AboutImageCarousel, SuccessStoriesCarousel, StickyMobileCTA
- capabilities.astro: AboutImageCarousel, SuccessStoriesCarousel, StickyMobileCTA
- All case-study pages: AboutImageCarousel, TestimonialsCarousel, SuccessStoriesCarousel, StickyMobileCTA
...
**Location:** 
- `src/components/react/AboutImageCarousel.tsx` (auto-advance)
...
**Location:** `src/components/react/AboutImageCarousel.tsx`  
...
2. **Reduced Motion Support** (Multiple files)
   ...
   - Files: 
     - `src/components/react/AboutImageCarousel.tsx`
...
8. **Carousel Arrow Key Support** (AboutImageCarousel.tsx)
   - Intent: Improve keyboard UX
   - Files: `src/components/react/AboutImageCarousel.tsx`
   - Risk: Low (additive)
...
2. **Reduced Motion Support** ✅
   - Added `prefers-reduced-motion` checks to `AboutImageCarousel` and `TestimonialsCarousel` (pause auto-advance)
   ...
   - Files: `src/components/react/AboutImageCarousel.tsx`, `TestimonialsCarousel.tsx`, `src/styles/global.css`, `src/pages/index.astro`
...
6. **Carousel Arrow Key Support** ✅
   - Added `onKeyDown` handler for ArrowLeft/ArrowRight on `AboutImageCarousel`
