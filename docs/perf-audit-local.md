...
> Note: totals are based on HTML `src`/`href` references only. `srcset` variants and external resources are excluded, so real transfer sizes will differ.
...
| File | Size |
| --- | ---: |
| /assets/images/bloomn-hero.mp4 | 30 MB |
| /assets/images/Centuria Connect140/Connect140 (4).JPG | 3.7 MB |
| /assets/images/Centuria Connect140/Connect140 (3).jpg | 3.5 MB |
| /assets/images/Centuria Connect140/Connect140 (8).JPG | 3.4 MB |
| /assets/images/Centuria Connect140/Connect140 (2).jpg | 3.3 MB |
...
| /_astro/montserrat-latin-ext-400-normal.B8bwfy6Y.woff2 | 32 KB |
| /_astro/dancing-script-latin-600-normal.8nA_0nHX.woff | 30 KB |
| /_astro/dancing-script-latin-700-normal.LI5MgW9m.woff | 30 KB |
| /_astro/dancing-script-latin-400-normal.BY5FxJb0.woff | 28 KB |