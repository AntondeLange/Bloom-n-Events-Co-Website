...
If you don't know something specific, suggest they contact the company directly through the contact page.`;
    ...
    // Footer accordion initialization is handled by footer-accordion.js
    // which exports window.initFooterAccordion() using Bootstrap collapse events
    // This ensures CSP compliance and proper event handling
    
    // Dead code removed: Local initFooterAccordion() function (lines 2836-3024)
    // was never called because main.js uses window.initFooterAccordion from footer-accordion.js instead
    
    // Initialize footer accordion after footer is loaded via loadPartials
    // (handled in loadPartials function above - lines 351-354 and 373-376)
});
